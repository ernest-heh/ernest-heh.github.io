      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2.5 md:gap-3 text-lg md:text-2xl items-center text-neutral-500 dark:text-neutral-200">
          ...
          <div
            id="tooltip-github"
            role="tooltip"
            className="absolute z-10 invisible inline-block px-2.5 py-1 text-xs font-medium text-white bg-neutral-600 rounded-full shadow-sm opacity-0 tooltip dark:bg-neutral-200 dark:text-neutral-800 transition-opacity duration-300"
          >
            GitHub
          </div>
